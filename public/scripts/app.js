        ...
        if (plugins.isotope.length) {
            ...
            for (var i = 0; i < plugins.isotope.length; i++) {
                var isotopeItem = plugins.isotope[i],
                    isotopeInitAttrs = {
                        ...
                        layoutMode:   isotopeItem.getAttribute('data-isotope-layouts') ? isotopeItem.getAttribute('data-isotope-layouts') : 'masonry',
                        filter:       '*'
                    };
            ...
            $("[data-isotope-filter]").on("click", function (e) {
                ...
                var iso = $('.isotope[data-isotope-group="' + this.getAttribute("data-isotope-group") + '"]'),
                    isotopeAttrs = {
                        itemSelector: '.isotope-item',
                        layoutMode:   iso.attr('data-isotope-layouts') ? iso.attr('data-isotope-layouts') : 'masonry',
            ...
            for (i = 0; i < plugins.rdMailForm.length; i++) {
                ...
                $form.attr('novalidate', 'novalidate').ajaxForm({
                    ...
                    success:      function (result) {
                        ...
                        result = result.data.length === 5 ? result.data : 'MF255';
                        output.text(msg[result]);
        ...
        */
        ...
        if (isDesktop && !isNoviBuilder) {
            $().UItoTop({
                ...
                containerClass: 'ui-to-top fas angle-up'
            });
        }
        ...
        if (plugins.rdNavbar.length) {
            ...
            for (i = j = 0, len = values.length; j < len; i = ++j) {
                ...
                if (plugins.rdNavbar.attr('data' + aliaces[i] + 'device-layouts')) {
                    responsiveNavbar[values[i]]['deviceLayout'] = plugins.rdNavbar.attr('data' + aliaces[i] + 'device-layouts');
                }
