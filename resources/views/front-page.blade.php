                ...
                <div class="row justify-content-sm-center justify-content-lg-start row-30 row-md-60">
                    <div class="col-sm-10 col-md-6 col-lg-10 col-xl-3">
                        ...
                        <p>Travels to Greenland are your local experts in Greenland. We will give you all the
                            ...
                            We are here to help you get the best experience of your visit to our beautiful country. Read <a href="https://travelstogreenland.com/en/about">more</a></p>
                    </div>
                    ...
                    <div class="col-sm-10 col-md-6 col-lg-4 col-xl-3">
                        ...
                        <ul class="list-xs">
                            ...
                            <li>
                                <dl class="list-terms-minimal">
                                    <dt>Address</dt>
                                    <dd>Tuapannguit 11B, 201, 3900 Nuuk</dd>
                                </dl>
                            </li>
                            <li>
                                <dl class="list-terms-minimal">
                            ...
                            <li>
                                <dl class="list-terms-minimal">
                                    <dt>E-mail</dt>
                                    <dd><a href="mailto:info@travelstogreenland.com">info@travelstogreenland.com</a></dd>
                                </dl>
                            </li>
